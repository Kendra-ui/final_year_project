 ...
 */
final class Version20230624114050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment CHANGE carts_id cart_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE payment CHANGE cart_id carts_id INT NOT NULL');
