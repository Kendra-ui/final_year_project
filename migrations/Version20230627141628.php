 ...
 */
final class Version20230627141628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE payment_id payment_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE payment_id payment_id INT NOT NULL');
    }
}
