 ...
 */
final class Version20230624113029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE problem CHANGE product_id productid_id INT NOT NULL');
        $this->addSql('ALTER TABLE problem ADD CONSTRAINT FK_D7E7CCC8AF89CCED FOREIGN KEY (productid_id) REFERENCES product (id)');
        $this->addSql('CREATE INDEX IDX_D7E7CCC8AF89CCED ON problem (productid_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE problem DROP FOREIGN KEY FK_D7E7CCC8AF89CCED');
        $this->addSql('DROP INDEX IDX_D7E7CCC8AF89CCED ON problem');
        $this->addSql('ALTER TABLE problem CHANGE productid_id product_id INT NOT NULL');
