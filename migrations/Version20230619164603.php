 ...
 */
final class Version20230619164603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD image VARCHAR(255) NOT NULL, ADD description VARCHAR(255) NOT NULL');
    }
