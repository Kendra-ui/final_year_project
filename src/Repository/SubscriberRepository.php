...
class SubscriberRepository extends ServiceEntityRepository
{
    ...
    public function findBySkinProblem($skinProblem)
    {
        return $this->createQueryBuilder('s')
            ->andWhere('s.skinProblem = :skinProblem')
    ...
    public function findBySkinType($skinType)
    {
        return $this->createQueryBuilder('s')
            ->andWhere('s.skinType = :skinType')
    ...
    public function getAllBySkinProblemOrSkinType($skinProblem, $skinType){
        return $this->createQueryBuilder('s');
